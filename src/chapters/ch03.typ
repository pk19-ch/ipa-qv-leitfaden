#import "../../theme/zh-mba.typ": tip_block, key_statement

= Facharbeit: IPA-Bericht
...
#key_statement[Was nicht dokumentiert ist, wird nicht bewertet.]
...
#strong[Projektaufbauorganisation]

- Personen/Rollen/Aufgaben/Verantwortung

#strong[Zeitplan] (max. 2 Seiten, 2- oder 4-Std-Raster)

- Planung und Realität

#strong[Arbeitsprotokoll (Journal)] (3 bis max. 10 Seiten)
...
#strong[Weitere wichtige Bestandteile]
...
== Quellen / Fremdleistung / Plagiat / Vorarbeiten / KI-Nutzung
...
#strong[Verwendung von KI-Tools] \
...
#tip_block[
  Der Upload sollte erst gestartet werden, wenn die PDF-Datei fertig erzeugt ist. Die Abgabe sollte frühzeitig getestet und überprüft werden, damit für alle hochgeladenen Dokumente der Inhalt und die Lesbarkeit gewährleistet sind.
]
